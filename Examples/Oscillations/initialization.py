...
cfile = {}
cfile['fitness'] = 'Oscillations/fitness.c'
cfile['init_history'] = 'Oscillations/init_history.c'
cfile['input'] =  'Oscillations/input.c'
...
# Rates for adding species nodes
...
# Rates for adding species nodes
dictionary_mutation['random_enhancer()']=0.2
...
dictionary_mutation['random_duplicate()']=0.1
