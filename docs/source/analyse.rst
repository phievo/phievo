...
You can easily delete an interaction or a species from an existing
network once you know its id through calling *delete\_clean* and
specifying the id and the type of the node to remove:
