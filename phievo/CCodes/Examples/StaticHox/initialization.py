...
cfile['fitness'] = 'Examples/StaticHox/fitness_static_hox.c'
cfile['geometry'] = 'linear_geometry.c'
cfile['init_history'] = 'Examples/StaticHox/init_history_0.c'
cfile['input'] =  'Examples/StaticHox/input_Hox_static.c'
