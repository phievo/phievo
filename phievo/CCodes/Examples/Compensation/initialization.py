...
dictionary_ranges={}
dictionary_ranges['Species.degradation']=[0.01,1.0/T]
...
cfile['fitness'] = 'Examples/Compensation/fitness_compensated_2.c'
cfile['geometry'] = 'linear_geometry.c'
cfile['init_history'] = 'Examples/Compensation/init_history_0.c'
cfile['input'] =  'Examples/Compensation/input_compensated_test_4.c'
...
dictionary_mutation['random_Interaction(\'PPI\')']=0.1
...
dictionary_mutation['remove_Interaction(\'CorePromoter\')']=0.04
...
dictionary_mutation['random_duplicate()']=0.0
#############################################################################
...
prmt['ncelltot']=10            #number of cells in an organism
...
prmt['nseed'] = 60   # number of times entire evol procedure repeated, see main program.  
prmt['firstseed'] = 40  #first seed
...
def init_network():
   ...
   parameters=[['Degradable', mutation.sample_dictionary_ranges('Species.degradation',random) ],['Complexable']]
