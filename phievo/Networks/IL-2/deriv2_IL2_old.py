...
def input_deriv_inC(net):
  """all rates fixed rates are hard coded from the initialization file. See all_parameters_2C below."""
  func="\n/******************input related reactions*********************/\n"
  func=func+"\t //Free input ligand degradation.\n"
  func=func+"\t rate=1.0/TAU_AG*s[2]*N_cell_;\n"
  func=func+"\t increment=rate;\n"
  func=func+"\t ds[0] -= increment;\n\n} "
  return func
